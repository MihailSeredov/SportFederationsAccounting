        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccreditationStatusId = table.Column<int>(type: "INTEGER", nullable: false),
                    FederationStateId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccreditationStatuses_Code",
                table: "AccreditationStatuses",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FederationStates_Code",
                table: "FederationStates",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SportTypes_Code",
                table: "SportTypes",
                column: "Code",
                unique: true);
        }
